...
In Frontend 2 we concentrate on improving the knowledge core JavaScript concepts and learn how to [progressively enhance][pe] interfaces with HTML, CSS & JavaScript. In so called Dev-❤️-Des sessions (based on a method developed by [De Voorhoede][voorhoede]) multiple frontend components are designed and build.
